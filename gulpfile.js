...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new hptoner name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/hptoner.png')) {
        fs.renameSync(__dirname + '/admin/hptoner.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/hptoner.html')) {
        fs.renameSync(__dirname + '/widgets/hptoner.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/hptoner/js/hptoner.js')) {
        fs.renameSync(__dirname + '/widgets/hptoner/js/hptoner.js', __dirname + '/widgets/hptoner/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/hptoner')) {
        fs.renameSync(__dirname + '/widgets/hptoner',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /hptoner/g,
        ...
        {
            match: /Hptoner/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Hptoner'
        },
        {
            match: /RenePilz/g,
            replacement: author
